...
do   
  ...
  do   
    ...
    echo $outFile
    sbatch --job-name="Seurat $dataset $cell" --ntasks=12 --mem=180000 --partition=longq --time=5-00:00:00 \
...
do
  echo $cell
  sbatch --job-name="Seurat $cell" --ntasks=12 --mem=180000 --partition=longq --time=3-00:00:00 \
