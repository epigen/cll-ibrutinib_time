...
pbmc@data.info <- pbmc@data.info[, colnames(pbmc@data.info)[!grepl("ClusterNames", colnames(pbmc@data.info))]]
pbmc@data.info <- pbmc@data.info[, colnames(pbmc@data.info)[!grepl("CellType", colnames(pbmc@data.info))]]
pbmc@data.info <- pbmc@data.info[, colnames(pbmc@data.info)[!grepl("patient", colnames(pbmc@data.info))]]
