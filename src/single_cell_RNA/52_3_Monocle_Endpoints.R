...
out <- "52_3_Monocle_inclDay30_Endpoints/"
...
pDiffGenes[comparison == "3vs2" | comparison == "3vs1", avg_diff := -avg_diff]
pDiffGenes[comparison == "3vs2", comparison := "2vs3"]
pDiffGenes[comparison == "3vs1", comparison := "1vs3"]
